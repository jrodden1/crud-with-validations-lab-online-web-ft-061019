class Song < ApplicationRecord
   #not sure if I want to use uniqueness for this requirement: "Cannot be repeated by the same artist in the same year"
   ...
   validates :genre, format: { with: /\A[a-zA-Z\-]+\z/, message: "only allows letters" }
